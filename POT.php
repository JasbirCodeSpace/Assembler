...
echo "<table border='1' class='table'>
                <thead>
                    <tr class='filters'>
                        ...
                        <th><input type='text' class='form-control' placeholder='Pseudo_opcode' disabled></th>
